...
namespace GaushalaAPI.Models
{
    public class CalfModel : AnimalModel
    {
        ...
        public CalfModel(SqlDataReader sqlrdr) : base(sqlrdr)
        {
            //base(sqlrdr);
        }
        public bool ValidateCalv(CalvsContext calvsContext, string type = "Add")
        {
            ...
            else if (calvsContext.isCategoryCalf(this.Category,this.Id) == false)
            {
                //Console.WriteLine("Unique ERROR");
                errors.Add("Category", "You Can Update Record Having Category 'CALF'");
                error = false;
            }
