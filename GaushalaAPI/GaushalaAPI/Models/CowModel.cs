...
namespace GaushalaAPI.Models
{
    public class CowModel : AnimalModel
    {
        ...
        public CowModel(SqlDataReader sqlrdr) : base(sqlrdr)
        {
            //base(sqlrdr);
        }
        public bool ValidateCow(CowsContext cowsContext, string type = "Add")
        {
            ...
            else if (cowsContext.isTagNoUnique(this.TagNo,this.Id)==false) {
            ...
            if (this.Lactation == null)
            {
                errors.Add("lactation", "Enter the Lactation Number");
                error = false;
            }
            if (this.DOB == null)
            {
            ...
            if (this.ButterFat == null)
            {
                errors.Add("butterFat", "Enter the Butter Fat of Cow");
                error = false;
            }
            this.ValidateImage();
            return error;
