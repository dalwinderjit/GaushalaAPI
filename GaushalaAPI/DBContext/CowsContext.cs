...
{
    public class CowsContext 
    {
        private readonly IConfiguration _configuration;
        public CowsContext(IConfiguration configuration)
        {
        ...
        public IEnumerable<Dictionary<string,object>> GetCows(CowFilterModel cowFilter)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    while (sqlrdr.Read())
                    {
                        //CowModel cowModel = new CowModel(sqlrdr);
        ...
        public Dictionary<int, string> GetCowsIdNamePairByTagNo(string tagNo,int pageno=1)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    while (sqlrdr.Read())
                    {
                        ...
                        cowModel.CowID = Convert.ToInt32(sqlrdr["CowID"]);
                        cowModel.CowTagNo = Convert.ToString(sqlrdr["CowTagNo"]);*/
                        /*m1.MilkingPK = Convert.ToInt64(sqlrdr["MilkingPK"]);
                        m1.CowNo = sqlrdr["CowNo"].ToString();
                        m1.Date = Convert.ToDateTime(sqlrdr["Date"]);
